...
const apiUrl = "https://api.thegraph.com/subgraphs/name/qualifydev/zoragover";
// const blockApi = "https://api.thegraph.com/subgraphs/name/blocklytics/ethereum-blocks";
const blockApi = "https://api.thegraph.com/subgraphs/name/blocklytics/kovan-blocks";
    ...
    return new Promise((resolve, reject) => {
        axios.post
            ...
            .then(async (res) => {
                ...
                await fetchBlockTimestamp(proposal.startBlock)
                    .then((res) => {
                        proposal.startTime = res;
                    })
                    .catch((error) => {
                        proposal.startTime = null;
                    })
                
                await fetchBlockTimestamp(proposal.endBlock)
                    .then((res) => {
                        proposal.endTime = res;
                    })
                    .catch((error) => {
...
const fetchHolders = () => {
    return new Promise((resolve, reject) => {
        axios.post
            ...
            .then((res) => {
                resolve(res.data.data.tokenHolders);
            })
            .catch((error) => {
                reject(error);
            });
